...
define(['lodash', 'utility/debug'], function(_, debug){
    ...
    */
    rotate = function(block, reverse){
        ...
        if (block.proto === 'O'){
            return block;  /* does not rotate squares */
        }
    ...
    */
    ...
    return {
        // translateSquares: translateSquares, /* debug only */
        // rotateAroundZeroCenter: rotateAroundZeroCenter, /* debug only */
        // getWidth: getWidth, /* debug only */
